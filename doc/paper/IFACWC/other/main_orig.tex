...
recent years, the system identification research community has shown renewed interest in deep-learning tools and techniques for data-driven modelling of non-linear dynamical systems \cite{ljung2020deep}. %..CITE OUR WORKS AND SIMILAR ONES \vskip 8em 
...
%exact evaluation of the marginal likelihood.
...
\begin{enumerate}
 \item A multisine with standard deviation 0.4~V and bandwidth [0\; 2]~kHz (same as training input);
 \item A multisine with standard deviation 0.4~V and bandwidth [1\; 2]~kHz;
 \item A multisine with standard deviation 0.4~V and bandwidth [0\; 10]~kHz;
 \item A multisine with standard deviation 0.8~V and bandwidth [0\; 2]~kHz.
 \end{enumerate}
